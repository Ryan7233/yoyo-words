...
- **森蝶成人背词路线**：默认从 CET4 开始，也可切换 ☕ 生活高频（1,800 词）、CET6 和考研；共 **6,911 个唯一英文词条**（CET4 3,844 / CET6 5,406 / 考研 4,801），先看单词、音标、词性和短释义，再做 10 题小测；重叠词只存一份进度，切换路线不用重复从零开始
- **成人记忆计划**：每天优先安排 20 个到期词和新词，完整词表按每 200 个分组，支持错词复习；成人测验只更新间隔记忆，不参与孩子的星星、毕业帽和贴纸奖励
...
- 选人页底部有**版本号**（当前 `版本 v21`），可确认是否已更新到最新；
