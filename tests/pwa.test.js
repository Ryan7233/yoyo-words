...
test('service worker lifecycle waits for activation and only deletes its own old caches', async () => {
  const { listeners, state } = loadWorker({
    cacheKeys: ['yoyo-words-v14', 'yoyo-words-v21', 'yoyo-words-v22', 'yoyo-words-v23', 'yoyo-words-v24', 'yoyo-words-v25', 'another-app-v9', 'shared-cache'],
  });
  ...
  await activateWork;
  assert.deepEqual(state.deleted, ['yoyo-words-v14', 'yoyo-words-v21', 'yoyo-words-v22', 'yoyo-words-v23', 'yoyo-words-v24']);
